...
export function Footer() {
  return (
    <footer style={{ backgroundColor: "#0a1f1b" }}>
      <div className="mx-auto max-w-7xl px-6 py-16">
        <div className="grid gap-12 md:grid-cols-6">
          {/* Brand column */}
          <div className="md:col-span-2">
            <div className="flex items-center gap-2.5 mb-4">
              <svg width="32" height="32" viewBox="0 0 204 215" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="mailto:urenlucas@gmail.com" className="mt-3 inline-flex items-center gap-1.5 text-sm text-[#4cba6a] hover:underline">
              <Mail size={14} />
              urenlucas@gmail.com
            </a>
          </div>
          ...
          <div>
            <h4 className="mb-4 text-xs font-semibold uppercase tracking-wider text-[#7fa89e]">Resources</h4>
            <ul className="space-y-2.5">
          ...
          <div>
            <h4 className="mb-4 text-xs font-semibold uppercase tracking-wider text-[#7fa89e]">Company</h4>
            <ul className="space-y-2.5">
      ...
      {/* Bottom bar */}
      <div className="border-t border-[#1a3c36]">
        <div className="mx-auto max-w-7xl px-6 py-4">
          <p className="text-center text-xs text-[#3d5e56]">
            {"© 2026 LucasUren | Victoria, BC, Canada | This is a cover letter disguised as a SaaS landing page. Hire me."}
          </p>
        </div>
      </div>
    </footer>
